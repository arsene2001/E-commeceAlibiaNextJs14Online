    ...
    try {
      ...
      switch (mode) {
        ...
        case MODE.RESET_PASSWORD:
          ...
          setMessage(
            "L'email de réinitialisation du mot de passe a été envoyé. Veuillez vérifier votre e-mail."
          );
          break;
      ...
      switch (response?.loginState) {
        case LoginState.SUCCESS:
          setMessage("Un succès !Vous êtes redirigé.");
        ...
        case LoginState.FAILURE:
          if (
            ...
            setError("Le courrier électronique existe déjà !");
  ...
  return (
    <div className="h-[calc(100vh-80px)] px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 flex items-center justify-center ">
      <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
        ...
        <button
          className="bg-lama text-white p-2 rounded-md disabled:bg-pink-200 disabled:cursor-not-allowed bg-red-400"
          disabled={isLoading}
        >
